...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/profileimg.png
  AssetGenImage get profileimg =>
      const AssetGenImage('assets/icons/profileimg.png');

  /// File path: assets/icons/song.png
  AssetGenImage get song => const AssetGenImage('assets/icons/song.png');
  ...
  List<AssetGenImage> get values =>
      [arrow, hashtag, icon, profileimg, song, user, w, write];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<dynamic> get values => [logo, programming, singlePlaceHolder, techbot];
}
